<?php
/**
 * iocinclude plugin (permalink header component)
 *
...
class syntax_plugin_iocinclude_header extends DokuWiki_Syntax_Plugin {
    ...
    function render($mode, Doku_Renderer $renderer, $data) {
        ...
        if ($mode == 'xhtml') {
            ...
            // the iocinclude header instruction is always at the beginning of the first section edit inside the iocinclude
