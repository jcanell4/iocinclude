...
/**
 * Helper functions for the iocinclude plugin and other plugins that want to iocinclude pages.
 */
class helper_plugin_iocinclude extends DokuWiki_Plugin { // DokuWiki_Helper_Plugin
    ...
    function _convert_instructions(&$ins, $lvl, $page, $sect, $flags, $root_id, $included_pages = array()) {
        ...
        // wrap content at the beginning of the iocinclude that is not in a section in a section
    ...
    /**
     * Appends instruction item for the iocinclude plugin footer
     *
     * @author Michael Klier <chi@chimeric.de>
     */
    ...
    /**
     * Gives a list of pages for a given iocinclude statement
     *
     * @author Michael Hamann <michael@content-space.de>
     */
    function _get_iocincluded_pages($mode, $page, $sect, $parent_id, $flags) {
        global $conf;
        $pages = array();
        switch($mode) {
        case 'namespace':
     ...
     * instructions.
     */
    function _get_iocincluded_pages_from_meta_instructions($instructions) {
        $pages = array();
        foreach ($instructions as $instruction) {
            ...
            $pages = array_merge($pages, $this->_get_iocincluded_pages($mode, $page, $sect, $parent_id, $flags));
        }
        return $pages;
    }
